...
contract BethTestToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    string public version = 'H1.0';       // How many units of your coin can be bought by 1 ETH?
    ...
    function BethTestToken() {
        ...
        name = "BethToken";                                        // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                             // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTKN";                                           // Set the symbol for display purposes (CHANGE THIS)
